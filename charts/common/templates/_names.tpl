...
Usage:
{{ include "common.names.service" (dict "name" .Values.path.to.service.name "context" $) }}
*/}}
{{- define "common.names.service" -}}
{{ default (include "common.names.fullname" .context) (.name | trunc 63 | lower | trimSuffix "-") }}
{{- end -}}